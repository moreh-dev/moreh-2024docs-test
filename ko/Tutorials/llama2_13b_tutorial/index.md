...
이 튜토리얼은 MoAI Platform에서 오픈 소스 [Llama2 13B](https://huggingface.co/meta-llama/Llama-2-13b-hf)을 fine-tuning하는 예시를 소개합니다. 튜토리얼을 통해 아래와 같은 MoAI Platform이 제공하는 여러 기능을 체험하며, AMD GPU 클러스터를 사용하는 방법을 익힐 수 있습니다.
...
- KT Cloud Hyperscale AI Computing ([https://cloud.kt.com/solution/hyperscaleAiComputing/](https://cloud.kt.com/solution/hyperscaleAiComputing/))
